function [MSByte Byte3 Byte2 LSByte] = ConvertLongToBytes(Word)
...
MSByte = uint8(bin2dec(Binary_1_8));
Byte3 = uint8(bin2dec(Binary_9_16));
Byte2 = uint8(bin2dec(Binary_17_24));
LSByte = uint8(bin2dec(Binary_25_32));
else
